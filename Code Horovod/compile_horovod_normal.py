...
from load_msd_five_data_normal import *
from test_msd_data import *
import keras
...
def main():
    ...
    plt.ylabel("loss")
    plt.xlabel("epoch")
    plt.savefig(f"Training_ms_msd_loss.png")
    ...
    plt.ylabel("accuracy")
    plt.xlabel("epoch")
    plt.savefig(f"Training_ms_msd_accuracy.png")
    ...
    plt.ylabel("val_loss")
    plt.xlabel("epoch")
    plt.savefig(f"Val_ms_msd_loss.png")
    ...
    plt.xlabel("epoch")
    plt.savefig(f"Val_ms_msd_accuracy.png")



    #if(hvd.rank() == 0):
    test_dataset, test_dataset1 = get_data()
