...
worker_index = tf.distribute.experimental.ParameterServerStrategy().num_replicas_in_sync
...
train_dataset = create_distributed_datasets(train_image_path, train_mask_path, augment=True, batch_size=BATCH_SIZE, shuffle_buffer_size=shuffle_buffer_size_train)
val_dataset = create_distributed_datasets(valid_image_path, valid_mask_path, batch_size=BATCH_SIZE, shuffle_buffer_size=shuffle_buffer_size_val)
